...
AppBar myStatusBarNew(BuildContext context) {
  final bool isDarkTheme = Theme.of(context).brightness == Brightness.dark;

  // ✅ Force update system overlay style
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
    statusBarColor: isDarkTheme
        ? Color(CommonColor.darkBgColor)
        : Colors.white,
  ...
  return AppBar(
    backgroundColor:
    isDarkTheme ? Color(CommonColor.darkBgColor) : Colors.white,
    systemOverlayStyle: SystemUiOverlayStyle(
      statusBarColor:
      isDarkTheme ? Color(CommonColor.darkBgColor) : Colors.white,
      statusBarIconBrightness:
